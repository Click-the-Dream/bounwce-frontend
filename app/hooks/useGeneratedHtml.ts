...
const useGeneratedHtml = (formData: FormData) => {
  ...
  return useMemo(() => {
    ...
    const rawContent = debouncedData.content || "Start typing your content...";
    const content = rawContent.replace(/&nbsp;/gi, " ").replace(/\u00a0/g, " ");
    ...
    <div class="email-card">
      ...
      <div class="footer">
        ...
        >
          <tr>
            <td width="33%">
              <a href="https://www.instagram.com/bouwnceofficial">
                <img
            ...
            <td width="33%">
              <a href="https://www.tiktok.com/@bouwnceofficial">
                <img
