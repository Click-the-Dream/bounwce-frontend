...
import { BarChart3, Calendar, MapPin, SquarePen } from "lucide-react";
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] overflow-hidden flex flex-col hover:shadow-[0_4px_25px_rgba(0,0,0,0.06)] transition duration-200">
      ...
      <div className="relative h-12 w-full bg-blue-900">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-r from-blue-700 to-indigo-900 flex items-center justify-center">
          <span className="text-white text-3xl font-extrabold tracking-widest opacity-25 uppercase select-none">
            web summit
          </span>
        </div>
        ...
        <button className="absolute top-3 right-3 text-white/80 hover:text-white transition cursor-pointer">
          <SquarePen size={14} />
        </button>
      </div>
      ...
      <div className="p-2 flex-1 flex flex-col justify-between">
        <div>
          <h3 className="text-sm font-medium text-black tracking-tight mb-2">
            {event.title}
          </h3>
